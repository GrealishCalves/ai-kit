...
Scraped from modelcontextprotocol.io/docs
...
Inherited from BaseMetadata.name
`Optional`outputSchemaoutputSchema?: {
  properties?: { [key: string]: object };
  required?: string[];
  type: "object";
}
...
  clientInfo: Implementation;
  protocolVersion: string;
}Type declarationcapabilities: ClientCapabilitiesclientInfo: ImplementationprotocolVersion: string
...
Inherited from Result.\_meta
`Optional`instructionsinstructions?: string
...
`Optional`nextCursornextCursor?: string
...
## 22. Connect to remote MCP Servers
...
## 23. Connect to local MCP servers
